          ...
          <Col xs={24} sm={12} md={6}>
            <Card hoverable style={{ borderRadius: "8px", height: "100%" }}>
              <Statistic
                ...
                prefix={
                  <Gift style={{ color: "#1890ff", display: "flex", alignItems: "center" }} />
                }
                suffix="个包"
                styles={{
                  content: {
          ...
          <Col xs={24} sm={12} md={6}>
            <Card hoverable style={{ borderRadius: "8px", height: "100%" }}>
              <Statistic
                ...
                prefix={
                  <Plus style={{ color: "#52c41a", display: "flex", alignItems: "center" }} />
                }
                suffix="个本周"
                styles={{
                  content: {
          ...
          <Col xs={24} sm={12} md={6}>
            <Card hoverable style={{ borderRadius: "8px", height: "100%" }}>
              <Statistic
                ...
                prefix={
                  <ChartColumn
                    style={{ color: "#faad14", display: "flex", alignItems: "center" }}
                  />
                }
                styles={{
                  content: {
          ...
          <Col xs={24} sm={12} md={6}>
            <Card hoverable style={{ borderRadius: "8px", height: "100%" }}>
              <Statistic
                ...
                prefix={
                  <UserRound style={{ color: "#eb2f96", display: "flex", alignItems: "center" }} />
                }
                styles={{
                  content: {
                    color: "#eb2f96",
